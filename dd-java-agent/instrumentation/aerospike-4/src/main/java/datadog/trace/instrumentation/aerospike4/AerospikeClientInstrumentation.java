...
public final class AerospikeClientInstrumentation extends Instrumenter.Default {
  ...
  public Map<? extends ElementMatcher<? super MethodDescription>, String> transformers() {
    ...
    transformers.put(
        isMethod()
            .and(isPublic().and(takesArgument(0, nameStartsWith("com.aerospike.client.policy")))),
        getClass().getName() + "$TraceSyncRequestAdvice");
    transformers.put(
        isMethod()
            .and(isPublic().and(takesArgument(1, nameStartsWith("com.aerospike.client.listener")))),
  ...
  public static final class TraceSyncRequestAdvice {
    ...
    public static AgentScope enterClient(@Advice.Origin("#m") final String methodName) {
  ...
  public static final class TraceAsyncRequestAdvice {
    @Advice.OnMethodEnter(suppress = Throwable.class)
    public static AgentScope enterClient(
